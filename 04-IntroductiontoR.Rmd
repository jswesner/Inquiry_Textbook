...
All of the examples in this book are generated using R. Actually, that's not quite correct. While R is the workhorse, the examples in this book are generated through an interface to R called RStudio [@rstudio_team_rstudio_2020].
...
**R for Data Science** (free) - <https://r4ds.had.co.nz/> [@grolemund]

**The R Book** [@crawley_r_2012]

**Getting Started with R: An Introduction for Biologists** [@beckerman_getting_2017] **D**

**ata Visualization: A Practical Introduction** [@healy_data_2018]
...
**What it does** This code uses the powerful plotting package called **ggplot2** [@wickham_ggplot2_2016]. It included when you installed the tidyverse. The "gg" stands for "The Grammar of Graphics" [@wilkinson)_2012-_grammar], a fundamental set of principles for producing just about any plot you can think of (and rules for why some types of plots are better than others).
