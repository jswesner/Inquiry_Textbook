...
All of the examples in this book are generated using R. Actually, that's not quite correct. While R is the workhorse, the examples in this book are generated through an interface to R called RStudio [@rstudio_2020].
...
**What it does** This code uses the powerful plotting package called **ggplot2** [@ggplot2]. It included when you installed the tidyverse. The "gg" stands for "The Grammar of Graphics" [@wilkinson2012grammar], a fundamental set of principles for producing just about any plot you can think of (and rules for why some types of plots are better than others).
