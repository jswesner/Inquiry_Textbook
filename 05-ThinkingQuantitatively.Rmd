...
The code below will generate the data set used in Figure 3 above called *drug\_data* - just copy it and run it. Don't worry about interpreting it for now.
...
Once we have a data set, we use the *group\_by()* and *summarize()* functions to generate the summary statistics.
