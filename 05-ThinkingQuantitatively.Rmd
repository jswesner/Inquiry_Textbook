...
```{r echo=F, fig.cap='Proportion of patients that recovered from a disease after taking one of three drugs. Each dot represents the outcome of a single experiment (i.e. trial).\\label{fig1:plot}', message=FALSE, warning=FALSE, out.width="60%", paged.print=FALSE}
...
ggsave(p1, file = here("figures/p1.svg"))

knitr::include_graphics(here("figures/p1.svg"))
