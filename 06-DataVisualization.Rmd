...
```{r, fig.cap = "Bad graph. Corners are stretched. Everything is blurry. Text is too small.", echo=FALSE, out.width = "70%", message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r echo=FALSE, fig.cap = "Better graph. Text is readable. Axis units are defined. Nothing is blurred. Colors are colorblind friendly.", out.width = "70%", message=FALSE, warning=FALSE, paged.print=FALSE}
